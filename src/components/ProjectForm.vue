...
<template>
  <div class="container-sm">
    ...
    <form @submit.prevent="ProjectHandler">
      ...
      <!-- Div classes that call the form group for respective input and label -->
      ...
      <div class="form-group">
        ...
        <input type="number" step=".01" min="0" class="form-control" v-model="total_cost"
...
export default {
   ...
   * @returns {{Customer_Name: string, total_cost: string, Date_Requested: string, Type_Of_Service:
   * string, Completed: number, date_completed: string, invoice_paid: number, Customer_Email:
